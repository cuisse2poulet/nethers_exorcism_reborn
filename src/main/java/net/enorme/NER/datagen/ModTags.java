...
public class ModTags {
    ...
    public static final TagKey<Block> NEVER_OBSTRUCT_NEST = TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(NethersExorcismMod.MODID, "tags/block/never_obstruct_nest.json"));
}
